...
<?php echo $this->Form->create('VideoclipCombo'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Videoclip Combo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VideoclipCombo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VideoclipCombo.id'))); ?></li>
