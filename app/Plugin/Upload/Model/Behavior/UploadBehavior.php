 ...
 **/
	...
	public function _prepareFilesForDeletion(Model $model, $field, $data, $options) {
		...
		/* Ualabi Solutions - 25/03/2013 - Variable was modified in order to solve error because 'dir' field is not in the database. 
		 * Begin
		 */
			//$dir = $data[$model->alias][$options['fields']['dir']];
			$dir = $data[$model->alias]['id'];
		/* Ualabi Solutions - 25/03/2013 - End */
